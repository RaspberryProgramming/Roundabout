{-
 -  HOPL/EXPLICIT_REFS/Environment.hs
 -
 ...
 -}
module HOPL.EXPLICIT_REFS.Environment (Env (..)) where

import HOPL.EXPLICIT_REFS.DataStructures (Binding, DenVal, Environment (..), ExpVal (ProcVal), Procedure (..))
