{-
 -  HOPL/CALL_BY_NEED/Lang/Parser.hs
 -
 -  Reference implementation of the toy language CALL_BY_NEED from the
 -  EOPL3 textbook by Mitchell Wand.
 -
 -  This module provides the grammatical specification for CALL_BY_NEED.
 -
 -  Author: Matthew A Johnson
 -}
module HOPL.CALL_BY_NEED.Lang.Parser
  ( parseToplevel,
    ParseError,
  )
where

import HOPL.CALL_BY_NEED.Lang.Lexer
