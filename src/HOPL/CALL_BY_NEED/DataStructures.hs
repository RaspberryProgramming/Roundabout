{-
 -  HOPL/CALL_BY_NEED/DataStructures.hs
 -
 ...
 -  supporting data structures in CALL_BY_NEED.
 -
 -  Author: Matthew A Johnson
 -}
module HOPL.CALL_BY_NEED.DataStructures
  ( ExpVal (..),
    DenVal,
    StoVal (..),
    MutPair,
